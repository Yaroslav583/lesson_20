<template>
  <div class="app">
    ...
    <p>
      ...
      <span :class="{ green: averageScore > previousAverage, red: averageScore < previousAverage }">
  {{ averageScore }}
  <span v-if="averageScore > previousAverage" class="up">&uArr;</span>
  <span v-if="averageScore < previousAverage" class="down">&dArr;</span>
</span>
    </p>
  </div>
</template>
